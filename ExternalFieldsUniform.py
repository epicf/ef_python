...
class ExternalFieldMagneticUniform(ExternalField):
    ...
    def write_hdf5_field_parameters(self, current_field_group):
        ...
        current_field_group.attrs.create("magnetic_uniform_field_x",
                                         self.magnetic_field.x)
        current_field_group.attrs.create("magnetic_uniform_field_y",
                                         self.magnetic_field.y)
        current_field_group.attrs.create("magnetic_uniform_field_z",
...
class ExternalFieldElectricUniform(ExternalField):
    ...
    def write_hdf5_field_parameters(self, current_field_group):
        current_field_group.attrs["field_type"] = self.field_type
        current_field_group.attrs.create("electric_uniform_field_x",
                                         self.electric_field.x)
        current_field_group.attrs.create("electric_uniform_field_y",
                                         self.electric_field.y)
        current_field_group.attrs.create("electric_uniform_field_z",
