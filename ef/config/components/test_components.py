...
from ef.config.parser import ConfigComponent
...
def test_conf_to_configparser_and_back():
    ...
    conf2 = ConfigComponent.parser_to_confs(parser)
    assert conf2 == confs
...
def test_minimal_example():
    ...
    components = [conf.make() for conf in ConfigComponent.parser_to_confs(parser)]
