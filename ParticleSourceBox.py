...
class ParticleSourceBox( ParticleSource ):
    ...
    def set_parameters_from_config( self, this_source_config_part ):
        self.xleft = this_source_config_part["box_x_left"]
        self.xright = this_source_config_part["box_x_right"]
        self.ytop = this_source_config_part["box_y_top"]
        self.ybottom = this_source_config_part["box_y_bottom"]
        self.znear = this_source_config_part["box_z_near"]
        self.zfar = this_source_config_part["box_z_far"]
