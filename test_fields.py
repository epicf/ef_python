...
class TestFields:
    ...
    def test_uniform(self):
        ...
        assert_array_almost_equal(m.total_electric_field_at_position((0, 0, 0), 2), (3.14, 2.7, -0.5))
        assert_array_almost_equal(m.total_magnetic_field_at_position((1, 2, 3), 5), (6.28, 5.4, -1))
    ...
    def test_expression(self):
        ...
        assert_array_almost_equal(m.total_electric_field_at_position((1, 2, 3), 0), (-1, -1, 7))
        assert_array_almost_equal(m.total_electric_field_at_position((1, 2, 3), 5), (4, -1, 7))
        assert_array_almost_equal(m.total_electric_field_at_position((3, 2, 1), 5), (4, 5, 5))
    ...
    def test_from_file(self):
        ...
        m = ExternalFieldsManager([f], [])
        assert_array_almost_equal(m.total_electric_field_at_position((.5, 1., .3), 10.), (0, .5, 1))
        assert_array_almost_equal(m.total_electric_field_at_position((0, .5, .7), 10), (1, 1.5, 2))
    ...
    def test_manager(self):
        ...
        assert_array_almost_equal(m.total_electric_field_at_position((.5, 1., .3), 10.), (12.14, 3.4, 1.3))
        assert_array_almost_equal(m.total_magnetic_field_at_position((.5, 1., .3), 10.), (12.14, 3.4, 1.3))
