...
class TestParticle:
    ...
    def test_field_at_point(self):
        ...
        assert_array_equal(p.field_at_point(Vec3d(2., 0., 1.)), Vec3d(-4, 0, 0))
        assert_array_equal(p.field_at_point((2., 0., 1.)), Vec3d(-4, 0, 0))
        assert_array_equal(p.field_at_point(np.array((2., 0., 1.))), Vec3d(-4, 0, 0))
        assert_array_equal(p.field_at_point(Vec3d(0., 0., 1.)), np.array([np.nan, np.nan, np.nan]))
